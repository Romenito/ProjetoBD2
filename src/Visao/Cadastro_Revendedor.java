 ...
 * @author Romen
 */
public class Cadastro_Revendedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bem Vindos ao SARC");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 0));
        jLabel2.setText("Sistema de Gerência de Vendas");
        ...
        jbCadastrar_Revendedor.setText("Cadastrar");
    ...
    private void jbCadastrar_RevendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCadastrar_RevendedorActionPerformed
        ...
        revendedordao.InserirRevendedor(revendedor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Revendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cadastro_Revendedor().setVisible(true);
            }
        });
    }
